...
//    }
    ...
    @Test
    void testGetReportBySpecification() throws Exception {
        when(this.specificationService.getReportBySpecification((SpecificationDto) any()))
                .thenReturn(new ResponseEntity<>(HttpStatus.CONTINUE));
        ...
        specificationDto.setValue("42");
        String content = (new ObjectMapper()).writeValueAsString(specificationDto);
        MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders.post("/api/v1/searchReport")
                .contentType(MediaType.APPLICATION_JSON)
                .content(content);
        ResultActions actualPerformResult = MockMvcBuilders.standaloneSetup(this.zenPackController)
                .build()
                .perform(requestBuilder);
        actualPerformResult.andExpect(MockMvcResultMatchers.status().is(100));
    }
    ...
    @Test
    void testSearchReport() throws Exception {
        when(this.zenPackServiceImpl.searchReport((com.ZenPack.Specification.SearchRequest) any()))
        ...
        searchFilterDto.setValueCols(new ArrayList<>());
        String content = (new ObjectMapper()).writeValueAsString(searchFilterDto);
        MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders.post("/api/v1/searchReportByFilter")
                .contentType(MediaType.APPLICATION_JSON)
                .content(content);
        MockMvcBuilders.standaloneSetup(this.zenPackController)
                .build()
                .perform(requestBuilder)
                .andExpect(MockMvcResultMatchers.status().isOk())
                .andExpect(MockMvcResultMatchers.content().contentType("application/json"));
//                .andExpect(MockMvcResultMatchers.content()
//                        .string(
//                                "{\"content\":[],\"pageable\":\"INSTANCE\",\"totalElements\":0,\"totalPages\":1,\"last\":true,\"size\":0,\"number"
//                                        + "\":0,\"numberOfElements\":0,\"sort\":{\"empty\":true,\"unsorted\":true,\"sorted\":false},\"first\":true,\"empty"
//                                        + "\":true}"));
    }

    @Test
    void testGetReportColumnsBySpecification() throws Exception {
        when(this.specificationService.getReportColumnsBySpecification((SpecificationDto) any()))
                .thenReturn(new ResponseEntity<>(HttpStatus.CONTINUE));
        ...
        specificationDto.setValue("42");
        String content = (new ObjectMapper()).writeValueAsString(specificationDto);
        MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders.post("/api/v1/searchReportColumns")
                .contentType(MediaType.APPLICATION_JSON)
                .content(content);
        ResultActions actualPerformResult = MockMvcBuilders.standaloneSetup(this.zenPackController)
                .build()
    ...
    @Test
    void testSearchReportColumns() throws Exception {
        when(this.zenPackServiceImpl.searchReportColumns((com.ZenPack.Specification.SearchRequest) any()))
                .thenReturn(new PageImpl<>(new ArrayList<>()));
        ...
        searchFilterDto.setValueCols(new ArrayList<>());
        String content = (new ObjectMapper()).writeValueAsString(searchFilterDto);
        MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders.post("/api/v1/searchReportColumnsByFilter")
                .contentType(MediaType.APPLICATION_JSON)
                .content(content);
        MockMvcBuilders.standaloneSetup(this.zenPackController)
                .build()
